...
{	
	...
	GPIO_InitStructure.GPIO_Pin = 0x043F; 			 	//PORTG复用推挽输出 
    ...
    FSMC_NORSRAMInitStructure.FSMC_BurstAccessMode =FSMC_BurstAccessMode_Disable;//突发模式FSMC_BurstAccessMode_Disable; 
