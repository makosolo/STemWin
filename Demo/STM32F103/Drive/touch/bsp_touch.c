...
/*******************************************************************************
* 函数名	: TP_Read_XOY
* 描述  	: 读取一个坐标值(x或者y)连续读取READ_TIMES次数据,对这些数据升序排列,
*             然后去掉最低和最高LOST_VAL个数,取平均值
* 参数  	: xy:指令（CMD_RDX/CMD_RDY）
* 返回值	: 读到的数据
*******************************************************************************/
...
/*******************************************************************************
* 函数名	: TP_Read_XY2
* 描述  	: 连续2次读取触摸屏IC,且这两次的偏差不能超过ERR_RANGE,满足条件,则认
*             为读数正确,否则读数错误.该函数能大大提高准确度
* 参数  	: x,y:读取到的坐标值
* 返回值	: 0,失败;1,成功
*******************************************************************************/
...
/*******************************************************************************
* 函数名	: TP_Get_Adjdata
* 描述  	: 得到保存在EEPROM里面的校准值
* 参数  	: 无
* 返回值	: 0，获取失败，要重新校准；1，成功获取数据
*******************************************************************************/
